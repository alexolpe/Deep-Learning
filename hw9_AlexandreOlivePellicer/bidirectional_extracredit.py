...
def train_model(model, dataloader, criterion, optimizer, num_epochs):
    ...
    torch.save(model.state_dict(), './model_100_epochs_extracredit_bidirectional_200.pth')
    ...
    with open('/home/aolivepe/ECE60146/HW9/loss_100_epochs_extracredit_bidirectional_200.pkl', 'wb') as archivo:
